...
class appProdProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('C:\\Projects\\symfony2\\app/cache/prod/assetic/config'), false)));
    ...
    {
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 1 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router.real')), 2 => new \Symfony\Bundle\DoctrineBundle\CacheWarmer\ProxyCacheWarmer($this), 3 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetWriterCacheWarmer($this, new \Assetic\AssetWriter('C:\\Projects\\symfony2\\app/../web'))));
    }
    ...
    protected function getDoctrine_Orm_DefaultConfigurationService()
    {
        ...
        $instance->setProxyDir('C:\\Projects\\symfony2\\app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file.temporary_storage'] = new \Symfony\Component\HttpFoundation\File\SessionBasedTemporaryStorage($this->get('session'), 'ThisTokenIsNotSoSecretChangeIt', 'C:\\Projects\\symfony2\\app/cache/prod/upload');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('C:\\Projects\\symfony2\\app/logs/prod.log', 100, false);
    }
    ...
    {
        return $this->services['router.cached'] = new \Symfony\Bundle\FrameworkBundle\Routing\CachedRouter('C:\\Projects\\symfony2\\app/cache/prod', 'appprodUrlMatcher', 'appprodUrlGenerator');
    }
    protected function getRouter_RealService()
    {
        return $this->services['router.real'] = new \Symfony\Component\Routing\Router(new \Symfony\Bundle\FrameworkBundle\Routing\LazyLoader($this, 'routing.loader.real'), 'C:\\Projects\\symfony2\\app/config/routing.yml', array('cache_dir' => 'C:\\Projects\\symfony2\\app/cache/prod', 'debug' => false, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appprodUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appprodUrlMatcher'));
    }
    ...
    {
        return $this->services['translator.real'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => 'C:\\Projects\\symfony2\\app/cache/prod/translations', 'debug' => false), $this->get('session'));
    }
    protected function getTwigService()
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'cache' => 'C:\\Projects\\symfony2\\app/cache/prod/twig', 'charset' => 'UTF-8'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), 'C:\\Projects\\symfony2\\app/../web', false);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'C:\\Projects\\symfony2\\app/cache/prod',
            ...
            'twig.options' => array(
                ...
                'cache' => 'C:\\Projects\\symfony2\\app/cache/prod/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => 'C:\\Projects\\symfony2\\app/cache/prod/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => 'C:\\Projects\\symfony2\\app/cache/prod/assetic',
